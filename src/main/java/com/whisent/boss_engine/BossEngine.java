...
import com.whisent.boss_engine.skill.ModSkills;
import com.whisent.boss_engine.test.client.renderer.entity.BatRenderer;
import com.whisent.boss_engine.test.entity.BatEntity;
import com.whisent.boss_engine.test.register.EntityRegistry;
...
public class BossEngine {
    ...
    public BossEngine() {
        ...
        LOGGER.debug("注册键");
        LOGGER.debug(BossSkillRegistry.BOSS_SKILLS.toString());
    }
